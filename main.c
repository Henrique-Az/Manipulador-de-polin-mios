...
int main(){
    ListaP *lista=criar();
    int op=0;
    char nome[31], nome1[31], nome2[31];
    while(op!=9){
        ...
        switch(op){
            ...
            case 4:
                ...
                scanf("%d", &op);
                removerExp(buscarListaNome(lista, nome), op);
                op=1;
                break;
            case 5:
                //Reinicializar
            ...
            case 7:
                ...
                fgets(nome, 31, stdin);
                nome[strlen(nome)-1]='\0';
                op=somarPol(lista, nome1, nome2, nome);
                if(op==4){
                    printf("O nome do polinomio resultante ja existe\n");
                } else if(op==3){
                    printf("Nao foram encontrados os polinomios buscados\n");
                }
                break;
            case 8:
                //Calcular P(x)
...
void inserirTermo(ListaP *lista){
    ...
    if(p==NULL){
        printf("O polinomio %s nao foi encontrado\n\n", nome);
    } else{
...
void Px(ListaP *l){
    ...
    scanf("%f", &x);
    printf("Insira o nome de um polinomio(Digite \"sair\" para parar de calcular): ");
    setbuf(stdin,NULL);
    ...
    while(strcmp(nomes[i], "sair")!=0){
        ...
        if(p==NULL){
            printf("O polinomio nao foi encontrado\n\n");
        } else{
